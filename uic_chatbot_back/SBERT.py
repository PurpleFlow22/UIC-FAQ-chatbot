...
def SBERT_get_reply(model, query, question_list, answer_list, question_list_emb, topk_SBERT, threshold_SBERT):
    ...
    return answer_list[index_ranked[0]], if_valid
...
def use_model_qa(model_path, QA_path):
    ...
    while (1):
        ...
        result, if_valid = SBERT_get_reply(model, query, question_list, answer_list, question_embeddings, topk_SBERT, threshold_SBERT)
        print(result)
